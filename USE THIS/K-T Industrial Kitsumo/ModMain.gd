...
const MOD_NAME = "K-Tech Industrial Kitsumo-KTI"
...
func _init(modLoader = ModLoader):
	...
	modLoader.installScriptExtension("res://K-T Industrial Kitsumo/CurrentGame.gd")
	modLoader.installScriptExtension("res://K-T Industrial Kitsumo/ships/Shipyard.gd")
