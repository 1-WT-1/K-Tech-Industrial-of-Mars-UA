...
const MOD_NAME = "K-Tech Industrial K-Series"
...
func _init(modLoader = ModLoader):
	...
	modLoader.installScriptExtension("res://K-T Industrial K-Series/CurrentGame.gd")
	modLoader.installScriptExtension("res://K-T Industrial K-Series/ships/Shipyard.gd")
