...
const MOD_PRIORITY = 13
# Name of the mod, used for writing to the logs
const MOD_NAME = "K-Tech Industrial CothonMk2"
...
func _init(modLoader = ModLoader):
	...
	modLoader.installScriptExtension("res://K-T Industrial Cothon Mk2/CurrentGame.gd")
	modLoader.installScriptExtension("res://K-T Industrial Cothon Mk2/ships/Shipyard.gd")
